...
# this is the tmux battery colors scheme i use
# this goes in .config/tmux/plugins/tmux-battery/scripts/battery_color_charge.sh
...
color_charge_primary_tier8_default='#98971a'
color_charge_primary_tier7_default='#98971a'
color_charge_primary_tier6_default='#c5962a'
color_charge_primary_tier5_default='#c5962a'
color_charge_primary_tier4_default='#d56d0e'
color_charge_primary_tier3_default='#d56d0e'
color_charge_primary_tier2_default='#b52e28'
color_charge_primary_tier1_default='#b52e28'
